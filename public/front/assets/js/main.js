...
let modalBtn = document.querySelector(".register")
let modal = document.querySelector(".modal-window")
let closeBtn = document.querySelector(".modal-content .close-btn button")
...
modalWindow.addEventListener("click", () => {
  if (event.target === modalWindow && event.target !== modalContent) {
    modal.style.display = "none";
  }
});
...
// let galeryMyModal = document.querySelector('.galery-modal');
// let galeryModalContent = document.querySelector('.galery-modal-content');

// galeryMyModal.addEventListener("click", () => {
//     if (event.target !== galeryModalContent && event.target === galeryMyModal) {
//         galeryMyModal.style.display = "none";
//     }
// });
