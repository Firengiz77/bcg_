...
class BlogRepository
{
            ...
            $blog->setTranslation('title', $request->lang??'az', $request->title);            $blog->setTranslation('desc', $request->lang??'az', $request->desc);
                ...
                if (!$image["status"]) {
                    ...
                    $blog->image = $image["data"];
                            ...
                            $blog->setTranslation('meta_title', $request->lang??'az', $request->meta_title);            $blog->setTranslation('meta_description', $request->lang??'az', $request->meta_description);            $blog->setTranslation('meta_keywords', $request->lang??'az', $request->meta_keywords);
    ...
    public function update($request, Blog $blog): array
    {
        ...
        try {
            ...
            $blog->setTranslation('meta_title', $request->lang, $request->meta_title);            $blog->setTranslation('meta_description', $request->lang, $request->meta_description);            $blog->setTranslation('meta_keywords', $request->lang, $request->meta_keywords);
