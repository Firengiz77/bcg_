...
class ProjectRepository
{
    ...
    public function store($request): array
    {
        ...
        try {
            ...
            $project = new Project();
            $project->setTranslation('country', $request->lang??'az', $request->country);    
            $project->setTranslation('title', $request->lang??'az', $request->title);     
            $project->setTranslation('status', $request->lang??'az', $request->status); 
    ...
    public function update($request, Project $project): array
    {
        ...
        try {
            ...
            $project->setTranslation('country', $request->lang, $request->country);       
            $project->setTranslation('title', $request->lang, $request->title);          
            $project->setTranslation('status', $request->lang, $request->status);         
