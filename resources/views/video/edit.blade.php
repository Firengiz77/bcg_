            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($video, array('route' => array('video.update', $video->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
<img src='/public/{{$video->image}}' width='200' class='mt-2'/>
...
{{ Form::text('link', $video->link, array('class' => 'form-control', 'placeholder' => __('Enter link'), 'required' => 'required')) }}
</div>
</div>
