            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($gallery, array('route' => array('gallery.update', $gallery->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
<img src='/public/{{$gallery->image}}' width='200' class='mt-2'/>
