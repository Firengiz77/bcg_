            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($equipment, array('route' => array('equipment.update', $equipment->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('name', $equipment->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('code', null, array('class' => 'form-control', 'placeholder' => __('Enter code'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::textarea('desc', $equipment->getTranslation('desc', $code), array('class' => 'form-control summernote-simple nicEdit', 'placeholder' => __('Enter desc'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('title', $equipment->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required')) }}
</div>
</div>
