            ...
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="row">
                        ...
                        <div class='col-12'><div class='form-group'>{{ Form::label('title', __('Short title'), array('class' => 'form-label')) }}{{ Form::text('title', null, array('class' => 'form-control', 'placeholder' => __('Enter short title'), 'required' => 'required')) }}</div></div>
<div class='col-12'><div class='form-group'>{{ Form::label('code', __('code'), array('class' => 'form-label')) }}{{ Form::text('code', null, array('class' => 'form-control', 'placeholder' => __('Enter code'), 'required' => 'required')) }}</div></div>
