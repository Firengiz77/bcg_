...
<div class='col-12'><div class='form-group'>{{ Form::label('number', __('number'), array('class' => 'form-label')) }}{{ Form::text('number', null, array('class' => 'form-control', 'placeholder' => __('Enter number'), 'required' => 'required')) }}</div></div>
