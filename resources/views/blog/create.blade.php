...
<div class='col-12'><div class='form-group'>{{ Form::label('meta_title', __('meta_title'), array('class' => 'form-label')) }}{{ Form::text('meta_title', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_title'), 'required' => 'required')) }}</div></div>
<div class='col-12'><div class='form-group'>{{ Form::label('meta_description', __('meta_description'), array('class' => 'form-label')) }}{{ Form::text('meta_description', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_description'), 'required' => 'required')) }}</div></div>
<div class='col-12'><div class='form-group'>{{ Form::label('meta_keywords', __('meta_keywords'), array('class' => 'form-label')) }}{{ Form::text('meta_keywords', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_keywords'), 'required' => 'required')) }}</div></div>
