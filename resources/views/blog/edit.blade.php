...
{{ Form::text('meta_title', $blog->getTranslation('meta_title', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_title'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('meta_description', $blog->getTranslation('meta_description', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_description'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('meta_keywords', $blog->getTranslation('meta_keywords', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_keywords'), 'required' => 'required')) }}
</div>
</div>
