            ...
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="row">
                            ...
                            <div class='col-12'><div class='form-group'>{{ Form::label('icon', __('Icon'), array('class' => 'form-label')) }}{{ Form::text('icon', null, array('class' => 'form-control', 'placeholder' => __('Enter icon'), 'required' => 'required')) }}</div></div>
