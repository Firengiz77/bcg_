            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($equipmentimage, array('route' => array('equipmentimage.update', $equipmentimage->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('image', null, array('class' => 'form-control', 'placeholder' => __('Enter image'), 'required' => 'required')) }}
</div>
</div>
...
<div class='col-12'>
<div class='form-group'>
{{ Form::label('equipment_id', __('equipment_id'), array('class' => 'form-label')) }}
{{ Form::text('equipment_id', null, array('class' => 'form-control', 'placeholder' => __('Enter equipment_id'), 'required' => 'required')) }}
</div>
</div>
