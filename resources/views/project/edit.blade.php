...
{{ Form::text('country', $project->getTranslation('country', $code), array('class' => 'form-control', 'placeholder' => __('Enter country'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('title', $project->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('status', $project->getTranslation('status', $code), array('class' => 'form-control', 'placeholder' => __('Enter status'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::textarea('desc', $project->getTranslation('desc', $code), array('class' => 'form-control  summernote-simple nicEdit', 'placeholder' => __('Enter desc'), 'required' => 'required')) }}
</div>
</div>
