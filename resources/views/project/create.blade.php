...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="row">
                        ...
                        <div class='col-12'><div class='form-group'>{{ Form::label('country', __('country'), array('class' => 'form-label')) }}{{ Form::text('country', null, array('class' => 'form-control', 'placeholder' => __('Enter country'), 'required' => 'required')) }}</div></div>
    ...
    <div class='col-12'><div class='form-group'>{{ Form::label('status', __('status'), array('class' => 'form-label')) }}{{ Form::text('status', null, array('class' => 'form-control', 'placeholder' => __('Enter status'), 'required' => 'required')) }}</div></div>
